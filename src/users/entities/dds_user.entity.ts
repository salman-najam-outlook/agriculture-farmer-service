...
@Table({ tableName: 'users_dds' })
@Directive('@key(fields: "id")')
@ObjectType()
export class UserDDS extends Model {
  ...
  @Column
  @Field({ description: 'registrationUserType', nullable: true })
  ...
  @Column
  @ForeignKey(()=>Organization)
  @Field(() => Int, { description: 'sub organization id', nullable: true })
